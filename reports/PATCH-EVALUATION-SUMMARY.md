...
| Patch | Status |
|-------|--------|
| `a11y-DRUPAL-A11Y-002-submit-button-contrast` | ❌ FAIL |
| `a11y-DRUPAL-A11Y-001-file-widget-display-labels` | ❌ FAIL |
| `a11y-DRUPAL-A11Y-005-language-switcher-contrast` | ❌ FAIL |

### PRIORITY 2

| Patch | Status |
|-------|--------|
| `a11y-DRUPAL-A11Y-006-theme-switcher-landmark` | ❌ FAIL |
| `a11y-DRUPAL-A11Y-007-messages-landmark-role` | ❌ FAIL |

### PRIORITY 3

| Patch | Status |
|-------|--------|
| `a11y-DRUPAL-A11Y-003-select-all-checkbox-label` | ❌ FAIL |
| `a11y-DRUPAL-A11Y-004-tabindex-buttons-test-form` | ❌ FAIL |
| `a11y-DRUPAL-A11Y-008-empty-table-headers` | ❌ FAIL |
| `a11y-DRUPAL-A11Y-009-module-summary-names` | ❌ FAIL |
| `a11y-LABEL-IN-NAME-004-filter-format-aria-label` | ❌ FAIL |
...
- `a11y-DRUPAL-A11Y-002-submit-button-contrast`: Introduces new violations
...
- `a11y-DRUPAL-A11Y-001-file-widget-display-labels`: Introduces new violations
...
- `a11y-DRUPAL-A11Y-005-language-switcher-contrast`: Introduces new violations
...
- `a11y-DRUPAL-A11Y-006-theme-switcher-landmark`: Introduces new violations
...
- `a11y-DRUPAL-A11Y-007-messages-landmark-role`: Introduces new violations
...
- `a11y-DRUPAL-A11Y-003-select-all-checkbox-label`: Introduces new violations
...
- `a11y-DRUPAL-A11Y-004-tabindex-buttons-test-form`: Introduces new violations
...
- `a11y-DRUPAL-A11Y-008-empty-table-headers`: Introduces new violations
...
- `a11y-DRUPAL-A11Y-009-module-summary-names`: Introduces new violations
...
- `a11y-LABEL-IN-NAME-004-filter-format-aria-label`: Introduces new violations
