...
**Flags:**
- *New administration navigation Machine name: navigation Version: 12*
  - nominalisation: "administration"
...
**Flags:**
- *0-dev Required by: Interface Translation (disabled)Configuration Translation (disabled)Content Translation (disabled)*
  - nominalisation: "Configuration"
...
- *Allows importing and exporting configuration changes*
  - nominalisation: "configuration"
- *0-dev Help for Configuration Manager Permissions for Configuration Manager Configure Configuration Manager*
  - nominalisation: "Configuration"
...
- *"New users will be required to validate their email address prior to logging into the site, and will be assigned a system"*
  - passive voice
- *"With this setting disabled, users will be logged in immediately upon registering, and may select their own passwords dur"*
  - passive voice
...
- *"0-dev Requires: Language (disabled)FileField Required by: Configuration Translation (disabled)"*
  - nominalisation: "Configuration"
...
- *"Users without this permission will not have access to email addresses on user pages or other places where they might be "*
...
- *"This is only used when the site is configured to use a separate administration theme on the Appearance page"*
  - passive voice, nominalisation: "administration"
...
- *"Instruct browsers to lazy load images if dimensions are specified"*
  - passive voice
- *"Use in conjunction with and place after the 'Track images uploaded via a Text Editor' filter that adds image dimensions "*
  - jargon: "via"
...
- *"(Use an address ending in your site's domain to help prevent this email being flagged as spam"*
  - passive voice
...
- *"Changes on this form will be saved, but overrides will take precedence"*
  - passive voice
- *"See configuration overrides documentation for more information"*
  - nominalisation: "configuration"
...
- *"It will only be used if you need to be contacted about your account or for opted-in notifications"*
  - passive voice
...
- *"This page is displayed when the requested document is denied to the current user"*
  - passive voice
...
- *"Error message One or more problems were detected with your Drupal installation"*
  - passive voice
...
- *"If set to None then the request must be made via HTTPS"*
  - jargon: "via"
