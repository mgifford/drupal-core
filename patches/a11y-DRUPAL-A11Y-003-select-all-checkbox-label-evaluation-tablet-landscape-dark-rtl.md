# Patch Evaluation Report: a11y-DRUPAL-A11Y-003-select-all-checkbox-label-tablet-landscape-dark-rtl

**Generated:** 2026-05-07 at 8:29:46 a.m.
...
- Variant ID: `tablet-landscape-dark-rtl`
...
|---|---|---|---|---|---|---|
| DRU-5e4f16dc | DRU-987EB788 | label-title-only | /admin/content | not-observed | - | - |
| DRU-f9c8d204 | DRU-987EB788 | label-title-only | /admin/people | not-observed | - | - |
...
**Conditions:**
- Requested: {"screenType":"tablet","orientation":"landscape","colorMode":"dark","direction":"rtl","viewport":{"width":1024,"height":768}}
- Before: {"screenType":"tablet","orientation":"landscape","viewport":{"width":1024,"height":768},"colorMode":"dark","direction":"rtl","language":"en","colorSchemeDetected":"dark","prefersContrast":"no-preference","forcedColors":"none","theme":"unknown","bodyClasses":["path-admin"]}
- After: {"screenType":"tablet","orientation":"landscape","viewport":{"width":1024,"height":768},"colorMode":"dark","direction":"rtl","language":"en","colorSchemeDetected":"dark","prefersContrast":"no-preference","forcedColors":"none","theme":"unknown","bodyClasses":["path-admin"]}
