...
**Generated:** 2026-07-18 at 6:14:27 p.m.
...
- **Pattern source age (hours):** 121.49
...
- **Captured at:** 2026-07-18T22:14:12.677Z
...
### Test 1: /a11y-empty-headers

**Skipped:** baseline-target-not-observed

**Skip diagnostics:**
- Requested rules: ["empty-table-header"]
- Required conditions: {"authRequired":false,"requested":{"screenType":"desktop","orientation":"landscape","colorMode":"light","direction":"ltr","viewport":{"width":1280,"height":1024}},"observedBefore":{"screenType":"desktop","orientation":"landscape","viewport":{"width":1280,"height":1024},"colorMode":"light","direction":"ltr","language":"en","colorSchemeDetected":"light","prefersContrast":"no-preference","forcedColors":"none","theme":"unknown","bodyClasses":["user-logged-in","path-a11y-empty-headers"]}}
- Matching rule violations before: {"empty-table-header":1}
- Selector counts before: {"table th":2,"thead th":2}
- Navigation before: {"requestedUrl":"http://drupal-core.ddev.site/a11y-empty-headers","finalUrl":"http://drupal-core.ddev.site/a11y-empty-headers","httpStatus":200,"redirected":false,"title":"Empty headers | Drush Site-Install","authState":{"loggedInClass":true,"logoutLink":true,"loginForm":false,"uid":1,"authenticated":true},"selectorCounts":{}}
- Reproduction candidates: [{"patternId":"DRU-1D23B830","ruleId":"empty-table-header","path":"/table","selector":"#edit-table-empty > thead > tr > .select-all","preferred":false}]
- Auth setup: {"attempted":true,"success":true,"method":"uli","uli":"http://drupal-core.ddev.site/user/reset/1/1784412863/[REDACTED]/login","finalUrl":"http://drupal-core.ddev.site/user/1/edit?pass-reset-token=[REDACTED]&check_logged_in=1","authState":{"loggedInClass":true,"logoutLink":true,"loginForm":true,"uid":1,"authenticated":true},"credentialAttempted":false,"error":null}
