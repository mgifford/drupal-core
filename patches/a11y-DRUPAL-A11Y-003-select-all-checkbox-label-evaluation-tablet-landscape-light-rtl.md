# Patch Evaluation Report: a11y-DRUPAL-A11Y-003-select-all-checkbox-label-tablet-landscape-light-rtl

**Generated:** 2026-05-07 at 8:26:39 a.m.
...
- Variant ID: `tablet-landscape-light-rtl`
...
|---|---|---|---|---|---|---|
| DRU-71c4be46 | DRU-987EB788 | label-title-only | /admin/content | not-observed | - | - |
| DRU-08a76c31 | DRU-987EB788 | label-title-only | /admin/people | not-observed | - | - |
...
**Conditions:**
- Requested: {"screenType":"tablet","orientation":"landscape","colorMode":"light","direction":"rtl","viewport":{"width":1024,"height":768}}
- Before: {"screenType":"tablet","orientation":"landscape","viewport":{"width":1024,"height":768},"colorMode":"light","direction":"rtl","language":"en","colorSchemeDetected":"light","prefersContrast":"no-preference","forcedColors":"none","theme":"unknown","bodyClasses":["path-admin"]}
- After: {"screenType":"tablet","orientation":"landscape","viewport":{"width":1024,"height":768},"colorMode":"light","direction":"rtl","language":"en","colorSchemeDetected":"light","prefersContrast":"no-preference","forcedColors":"none","theme":"unknown","bodyClasses":["path-admin"]}
