...
This project uses [drupal-claude-skills](https://github.com/grasmash/drupal-claude-skills) — a collection of Claude Code skills and agents for Drupal development.

Skills and agents are installed in `.claude/skills/` and `.claude/agents/`.

---

## Agent Workflow Guide

The following sections are adapted from [grasmash/drupal-claude-skills AGENTS.md](https://github.com/grasmash/drupal-claude-skills/blob/main/AGENTS.md).
